...
filterSlit_thickness=1; // for flexible filters to squeeze them in
...
difference(){
    rotate([ -45, 0, 0 ]) difference(){
        ...
        translate([ -0.5, depth+dbw*2, 0]) rotate([ 45, 0, 0 ]) cube([1+front+corr, front+corr, front_height*2 ]);
    ...
    //PCB slit
    translate([ 0, equi_side+dbw/2-PCB_y+ext, PCB_z+ext/2 ]) cube([front, PCB_y*2, PCB_z+corr ]); 
    
    //blue filter slit
    translate([ 0, equi_side-PCB_y/2, 12+ext/2 ]) cube([front, depth, filterSlit_thickness ]);    
...
//PCB click-in   
difference(){   
#translate([ 0, equi_side+dbw/2-PCB_y+ext+8, PCB_z+ext/2 ]) cube([front, 3.8, 0.32]);
   translate([ wall, wall, 0 ]) cube([front-wall*2, depth-wall, front_height-wall ]); 
   } 
...
difference(){   
translate([ 0, equi_side+1, -0.32+12+ext/2 ]) cube([front, 8, filterSlit_thickness ]);
   translate([ wall, wall, 0 ]) cube([front-wall*2, depth-wall, front_height-wall ]); 
   } 
}     
